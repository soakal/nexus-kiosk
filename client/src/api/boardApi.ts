...
export async function importJobsJson(jobs: Job[]): Promise<{ imported: number; warnings: string[] }> {
...
export async function importJobsFile(file: File): Promise<{ imported: number; warnings: string[] }> {
